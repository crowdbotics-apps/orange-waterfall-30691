...
## Project Structure
    ...
    ├── orange_waterfall_30691  # Django project configurations
...
1. Clone this repo and `cd orange_waterfall_30691`
...
2. Clone this repo and `cd orange_waterfall_30691`
